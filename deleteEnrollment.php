...
if (isset($_GET['ID'])) {
    ...
    $sql = "DELETE FROM individualenrollment WHERE ID = $id";
...
<body>
    <div class="container">
        ...
        if (isset($_GET['ID']) && isset($_GET['eventName'])) {
            ...
            echo "<p>Are you sure you want to unenroll this participant in the event: <strong>$eventName</strong>?</p>";
            echo "<p><a href='deleteEnrollmentAction.php?ID=$ID&eventName=$eventName' class='btn btn-danger'>Yes, Unenroll</a></p>";
    ...
    <script>
        function confirmUnenroll() {
            return confirm('Are you sure you want to unenroll this participant in this event?');
        }
    </script>
</body>
</html>
